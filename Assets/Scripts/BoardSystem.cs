...
{
    [Header("Î≥¥Îìú ÌÅ¨Í∏∞ ÏÑ§Ï†ï")]
    [SerializeField, Tooltip("Î≥¥ÎìúÏùò Í∞ÄÎ°ú ÌÅ¨Í∏∞")] private int width = 6;
    [SerializeField, Tooltip("Î≥¥ÎìúÏùò ÏÑ∏Î°ú ÌÅ¨Í∏∞")] private int height = 8;
    
    [Header("ÌîºÏä§ Í∞Ñ Í∞ÑÍ≤© ÏÑ§Ï†ï")]
    [SerializeField, Tooltip("ÌîºÏä§Ïùò Í∞ÄÎ°ú Í∞ÑÍ≤©")] private float spacingX;
    [SerializeField, Tooltip("ÌîºÏä§Ïùò ÏÑ∏Î°ú Í∞ÑÍ≤©")] private float spacingY;
    
    [Header("ÌîºÏä§ ÌîÑÎ¶¨Ìåπ ÏÑ§Ï†ï")]
    [SerializeField, Tooltip("Î≥¥ÎìúÏóê ÏÉùÏÑ±Ìï† ÌîºÏä§ ÌîÑÎ¶¨Ìåπ(Prefab)")] private GameObject[] piecePrefabs;
    
    [Header("ÌîºÏä§ Î∂ÄÎ™® Ïò§Î∏åÏ†ùÌä∏ ÏÑ§Ï†ï")]
    [SerializeField, Tooltip("Î∂ÄÎ™® Ïò§Î∏åÏ†ùÌä∏ ÏÑ§Ï†ï(Î≥¥ÌÜµ Ïä§ÌÅ¨Î¶ΩÌä∏ ÎÑ£ÏùÄ Î≥¥Îìú Í≤åÏûÑ Ïò§Î∏åÏ†ùÌä∏ ÎÑ£Ïùå)"
         )] private Transform piecesRoot;
    
    [Header("Î≥¥Îìú Î†àÏù¥ÏïÑÏõÉ ÏÑ§Ï†ï")]
    ...
    /// ∆˜º«¿ª ∏¬≠ü¥¯ ∞≈∏¶ ªË¡¶«‘
    /// </summary>
    /// <param name="removeTargets">∆˜º« ∏¬√Ë¥¯∞≈∏¶ ∫∏∞¸«ﬁ¥¯ ∫Øºˆ</param>
